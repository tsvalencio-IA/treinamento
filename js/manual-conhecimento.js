export const MANUAL_TOUR = [
  {
    ...
    "duration": 10,
    "body": "Esta apresentação usa o próprio index.html do projeto dentro da moldura. Portanto, telas, botões, responsividade, permissões e dados exibidos são os mesmos da plataforma publicada. O guia apenas navega e destaca; não confirma vendas, importações ou estornos."
  },
  {
    "id": "login",
    "chapter": "Começo",
    ...
    "duration": 8,
    "body": "Quando não existe sessão autenticada, a própria tela real de login aparece. Depois do acesso, o Firebase carrega o perfil, verifica se o usuário está ativo e aplica as permissões pelo cargo. Administrador Master e Gerente têm os recursos administrativos; vendedor, atendente e entregador veem somente o que suas regras permitem."
  },
  {
    "id": "navigation",
    "chapter": "Começo",
